...
const ModalSentvalueWallet: FunctionComponent<ModalTypeProps> = ({ setShowModalSentValue})=> {
    ...
    return (
      ...
      <div className="w-[263px] bg-whitePrimary px-4 rounded-[20px] pb-4">
        ...
        <div className="flex gap-[11px]">
          <button className="border-2 rounded-md" onClick={()=> setShowModalSentValue(false)}>
